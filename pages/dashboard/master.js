    ...
    <Layout>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-10">
        <div className="card text-center">
          <p className="text-2xl font-bold text-aurora-green">{products.length}</p>
          <p className="text-gray-500">товаров</p>
        </div>
        <div className="card text-center">
          <p className="text-2xl font-bold text-aurora-green">{masterclasses.length}</p>
          <p className="text-gray-500">мастер‑классов</p>
        </div>
        <div className="card text-center">
          <p className="text-2xl font-bold text-aurora-green">{totalRevenue} ₽</p>
          <p className="text-gray-500">доход (комиссия {totalCommission} ₽)</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-10 mb-12">
        ...
        <div className="card">
          ...
          <form onSubmit={addMasterclass} className="space-y-4">
            ...
            <input value={mcPrice} onChange={e => setMcPrice(e.target.value)} placeholder="Цена (или 0)" type="number" className="w-full px-4 py-3 rounded-full border border-gray-200 focus:outline-none focus:border-aurora-green" />
